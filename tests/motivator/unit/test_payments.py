...
def test_create_payment_valid(monkeypatch: MonkeyPatch, goal: Goal):
    """
    GIVEN
    WHEN
    THEN
...
def test_get_payment_info(monkeypatch: MonkeyPatch):
    """
    GIVEN
    WHEN
    THEN
...
@pytest.mark.django_db
def test_create_refund_valid(monkeypatch: MonkeyPatch):
    """
    GIVEN
    WHEN
    THEN
...
@pytest.mark.django_db
def test_get_or_create_payment_valid(monkeypatch: MonkeyPatch, goal):
    """
    GIVEN
    WHEN
    THEN
